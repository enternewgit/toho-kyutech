  ...
  return (
    <div>
      <div className="text-center mb-6 md:mb-8">
        <h1 className="text-2xl md:text-4xl font-bold mb-4">サークル紹介</h1>
        <p className="text-base md:text-lg text-gray-600">東方求徹区について</p>
      </div>
      
      <div className="space-y-4 md:space-y-6">
        <section className="bg-white/80 rounded-lg p-4 md:p-6">
          <h2 className="text-xl md:text-2xl font-bold mb-4">東方求徹区について</h2>
        ...
        <section className="bg-white/80 rounded-lg p-4 md:p-6">
          <h2 className="text-xl md:text-2xl font-bold mb-4">活動内容</h2>
